...
public class MainService extends CommonService {
	...
	public int regSuggestReply(Map<String, Object> paramMap) throws Exception {
		...
		return mainDAO.insertSuggestReply(paramMap);
	}

	public int regStoryReply(Map<String, Object> paramMap) throws Exception {
		String[] reqKeys = {"storySeq", "bucketSeq", "userSeq"};			// 필수키
		super.checkVal(paramMap, reqKeys);			// 벨리데이션 체크

		return mainDAO.insertStoryReply(paramMap);
	}
	...
	public int deleteStoryReply(Map<String, Object> paramMap) throws Exception {
		String[] reqKeys = {"bucketSeq", "storySeq", "replyNo"};					// 필수키
		super.checkVal(paramMap, reqKeys);					// 벨리데이션 체크

		return mainDAO.deleteStoryReply(paramMap);	// 버킷 등록
	}

	public void deleteBucket(Map<String, Object> paramMap) throws Exception {
	...
	public void saveSuccessYn(Map<String, Object> paramMap) throws Exception {
		String[] reqKeys = {"bucketSeq", "successYn"};					// 필수키
		super.checkVal(paramMap, reqKeys);					// 벨리데이션 체크

		mainDAO.updateSuccessYn(paramMap);	// 버킷 등록
