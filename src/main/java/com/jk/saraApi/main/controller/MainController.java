...
public class MainController extends CommonController {
    ...
    public Map<String, Object> getBucketList(@RequestBody Map<String, Object> paramMap, HttpServletRequest request) throws Exception {
        System.out.println("일단 호출됐죠123123!!!!!!!!!!!??");
    ...
    @ResponseBody
    @PostMapping( value = "/getStoryReplyList" )
    public Map<String, Object> getStoryReplyList(@RequestBody Map<String, Object> paramMap, HttpServletRequest request) throws Exception {
        Map<String, Object> rsMap = mainService.getStoryReplyList(paramMap);
    ...
    @ResponseBody
    @PostMapping( value = "/deleteStoryReply" )
    public Map<String, Object> deleteStoryReply(HttpServletRequest request, @RequestParam Map<String, Object> paramMap) throws Exception {
        Map<String, Object> rsMap = new HashMap<String, Object>();

        int rsCnt = mainService.deleteStoryReply(paramMap);
    ...
    public Map<String, Object> regFollow(HttpServletRequest request, @RequestParam Map<String, Object> paramMap) throws Exception {
        Map<String, Object> rsMap = new HashMap<String, Object>();
    ...
    public Map<String, Object> delFollow(HttpServletRequest request, @RequestParam Map<String, Object> paramMap) throws Exception {
        Map<String, Object> rsMap = new HashMap<String, Object>();
    ...
    @ResponseBody
    @PostMapping( value = "/saveSuccessYn" )
    public Map<String, Object> saveSuccessYn(HttpServletRequest request, @RequestParam Map<String, Object> paramMap) throws Exception {
        Map<String, Object> rsMap = new HashMap<String, Object>();

        mainService.saveSuccessYn(paramMap);
